...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'controllers_file',
            default_value='rv80fr_controllers.yaml',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'description_file',
            default_value='rv80fr/rv80fr.urdf.xacro',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'robot_controller',
            default_value='rv80fr_controller',
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare(description_package), 'rviz', 'rv80fr.rviz']
    )
