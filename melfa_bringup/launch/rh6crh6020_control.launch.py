...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'controllers_file',
            default_value='rh6crh6020_controllers.yaml',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'description_file',
            default_value='rh6crh6020/rh6crh6020.urdf.xacro',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'robot_controller',
            default_value='rh6crh6020_controller',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value='initial_positions_rh6crh.yaml',
