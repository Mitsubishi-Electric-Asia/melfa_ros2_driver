...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="melfa_rv13frl_moveit_config",
    ...
    moveit_config = (
        MoveItConfigsBuilder("rv13frl", package_name="melfa_rv13frl_moveit_config")
        .robot_description(
            file_path="config/rv13frl.urdf.xacro",
        )
        .robot_description_semantic(file_path="config/rv13frl.srdf")
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare(moveit_config_package), "rviz", "rv13frl_moveit.rviz"]
    )
    rviz_node = Node(
        package="rviz2",
    ...
    servo_params = (
        ParameterBuilder("melfa_rv13frl_moveit_config")
        .yaml(
            parameter_namespace="moveit_servo",
            file_path="config/rv13frl_servo.yaml",
        )
        .to_dict()
    )
