...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="melfa_rh6crh6020_moveit_config",
    ...
    moveit_config = (
        MoveItConfigsBuilder("rh6crh6020", package_name="melfa_rh6crh6020_moveit_config")
        .robot_description(
            file_path="config/rh6crh6020.urdf.xacro",
        )
        .robot_description_semantic(file_path="config/rh6crh6020.srdf")
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare(moveit_config_package), "rviz", "rh6crh6020_moveit.rviz"]
    )
    rviz_node = Node(
        package="rviz2",
    ...
    servo_params = (
        ParameterBuilder("melfa_rh6crh6020_moveit_config")
        .yaml(
            parameter_namespace="moveit_servo",
            file_path="config/rh6crh6020_servo.yaml",
        )
        .to_dict()
    )
