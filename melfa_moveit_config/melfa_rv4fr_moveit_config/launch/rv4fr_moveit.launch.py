...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="melfa_rv4fr_moveit_config",
    ...
    moveit_config = (
        MoveItConfigsBuilder("rv4fr", package_name="melfa_rv4fr_moveit_config")
        .robot_description(
            file_path="config/rv4fr.urdf.xacro",
        )
        .robot_description_semantic(file_path="config/rv4fr.srdf")
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare(moveit_config_package), "rviz", "rv4fr_moveit.rviz"]
    )
    rviz_node = Node(
        package="rviz2",
    ...
    servo_params = (
        ParameterBuilder("melfa_rv4fr_moveit_config")
        .yaml(
            parameter_namespace="moveit_servo",
            file_path="config/rv4fr_servo.yaml",
        )
        .to_dict()
    )
